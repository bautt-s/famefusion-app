const SearchbarSection: React.FC = () => {
    return (
        <div className="flex flex-col items-center mt-[140px] pb-[60px]">
            <h1 className="outfit text-5xl font-[700]">Explore the World of Celebrities</h1>
            ...
            <form className='flex flex-row mt-[25px] border-[#bec2c2] border-[1px] border-r-0 rounded-2xl'>
                <input type="text" placeholder="Enter the name, keywords, category"
                    ...
                    border-r-0 w-[610px] py-[10px] pl-[15px] pr-[30px]' />
