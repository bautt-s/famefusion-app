const BusName: React.FC<any> = (props) => {
    ...
    return (
        <div>
            ...
            <span className="text-[#646868]">
                Clearly state the name of the business or company.
            </span>
            ...
            <div className="bg-white py-4 mt-[25px]">
                <div className="relative bg-inherit">
                    <input type="text" id="username" name="username" value={data.alias}
                     ...
                     focus:outline-none focus:border-rose-600" placeholder="Enter the company name"
                    ...
                    peer-focus:text-[#FB5870] peer-focus:text-sm transition-all">Enter the company name</label>
                </div>
            </div>
        </div>
    )
