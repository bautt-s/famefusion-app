    ...
    return (
        <section className="w-full flex flex-row px-[40px] lg:px-[60px] xl:px-[120px] 2xl:px-[200px] py-[100px] mt-[80px]">
            <div className='flex flex-col w-full md:w-fit items-center md:items-start'>
                <h1 className='text-5xl 2xl:text-6xl outfit sm:max-w-[15ch] md:max-w-[10ch] tracking-tight
                lg:max-w-[15ch] text-[#1f1f1f] font-[600] leading-[60px] text-center md:text-left'>
                    Connect with Your Favorite 
                    <strong className='text-[#FB5870]'> Celebrities</strong>
                </h1>

                <p className='akatab text-xl md:text-lg lg:text-xl max-w-[35ch] lg:max-w-[40ch] 2xl:max-w-[50ch] 
                lg:text-justify mt-[40px] font-[500] text-center md:text-left'>
